...
YOUR_LOGGING_DIRECTORY="logs/$METHOD-$ENV-step$STEP-w$WEIGHT-load.log"
...
"train_cfg.total_steps=25000000" "train_cfg.n_checkpoint=500000" "train_cfg.n_eval=500000" \
