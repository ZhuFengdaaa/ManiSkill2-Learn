...
YOUR_LOGGING_DIRECTORY="logs/dapg-StackCube-log/"
GPU="6"
...
python maniskill2_learn/apis/run_rl.py configs/mfrl/dapg/maniskill2_pn.py \
            ...
            "agent_cfg.demo_replay_cfg.buffer_filenames=/isaac/ManiSkill2-data/rigid_body_envs/StackCube-v0/trajectory.h5" \
